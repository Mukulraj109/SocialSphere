...
3. **Install the dependencies**: Now, you can install the necessary dependencies for the project:
    ...
    ```
4. **Set up environment variables**: Copy the `.env.sample` file and rename it to `.env`. Then, fill in the necessary environment variables.
...
import this file in postman collection.: https://drive.google.com/file/d/1d2QQiKQU_PP-Sh5gEEXmlKa8ISiGGhOB/view?usp=sharing
